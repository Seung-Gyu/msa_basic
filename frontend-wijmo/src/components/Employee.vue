<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <Department offline label="" v-model="value." :editMode="editMode" @change="change"/>
            <Rank offline label="" v-model="value." :editMode="editMode" @change="change"/>
            <DepartmentId offline label="DepartmentIds" v-model="value.departmentIds" :editMode="editMode" @change="change"/>
