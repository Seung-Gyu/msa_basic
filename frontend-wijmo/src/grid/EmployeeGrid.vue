<template>
    <div style="max-height:80vh;">
        ...
        >
            <wj-flex-grid-filter :filterColumns="['userId','isManager','','','departmentIds','departmentId','departmentId','rankId',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="departmentIds[0].name" header="departmentIds" width="2*" :isReadOnly="true" align="center" />
        ...
        <DepartmentIdsDetailGrid :selectedGrid="selectedGrid" />
...
import DepartmentIdsDetailGrid from './DepartmentIdsDetailGrid.vue'
...
export default {
    ...
    methods:{
        ...
        onSelectionChanged(s) {
            ...
            if (selectedItem) {
                this.selectedGrid = selectedItem.departmentIds;
